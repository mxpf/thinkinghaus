...
I found [Andrew Plotkin](https://www.eblong.com/zarf/myself.html)’s website about twenty years ago because I was obsessed with interactive fiction. I had played [*Spider and Web*](https://eblong.com/zarf/zweb/tangle/), a spy story that does things with deception, memory, and the role of the player that I had never seen a game do before. I was so struck by the craft of it that I went hunting for the person who had made it.

[The site](https://eblong.com/zarf/home.html) runs deep. Games, art projects, essays, software, photographs, talks, science, technical standards, jokes, a personal history, and a library database containing thousands of books are all sitting there. The so-called “[redundant site map](https://eblong.com/zarf/map.html)” is less a navigation aid than a warning about what you’re getting yourself into.
...
[The games](https://www.eblong.com/zarf/if.html) are the reason I arrived, and they remain extraordinary. His interactive-fiction page stretches from early experiments through *The Dreamhold*, *Shade*, *Spider and Web*, and a pile of stranger little things. Then there’s [*Hadean Lands*](https://www.eblong.com/zarf/if.html#hadean), his enormous alchemical puzzle box and, at least for me, his magnum opus. He has been part of the interactive-fiction community for decades; the site doesn’t present this as a heroic career arc so much as: this is what I’ve been doing.
...
The site does the opposite. The [About Zarfhome](https://www.eblong.com/zarf/) page says plainly that the site is about what he does and how he does it. He talks about showing drafts, tools, half-baked ideas, abandoned ideas, finished things, and failures. His phrase for it is “work in daylight.” He makes a distinction I’ve carried around for years: being a professional at one thing doesn’t mean the rest of what you make has to disappear.

The site is mostly plain HTML, and the About page famously tells the reader to “choose your own damn default background color.” He means it as a statement about making the site work anywhere rather than controlling every pixel. That refusal to micromanage how the browser behaves has been sitting in the back of my head while I’ve been designing Thinkinghaus.
